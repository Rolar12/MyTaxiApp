...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private DatabaseReference driversGeoFireDatabaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        driversGeoFireDatabaseReference = FirebaseDatabase.getInstance().getReference().child("driversGeoFire");
        ...
        bookTaxiButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                bookTaxiButton.setText("Getting your car...");
                getTheNearestCar();
            }
        });
    ...
    private void getTheNearestCar() {

        GeoFire geoFire = new GeoFire(driversGeoFireDatabaseReference);
    ...
    private void getTheNearestDriverLocation() {
        ...
        nearestDriverLocation.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    List<Object> driversLocationParameters = (List<Object>) dataSnapshot.getValue();

                    double latitude = 0;
                    double longitude = 0;

                    if (driversLocationParameters.get(0) != null) {
                        latitude = Double.parseDouble(driversLocationParameters.get(0).toString());
                    }
                    if (driversLocationParameters.get(1) != null) {
                        longitude = Double.parseDouble(driversLocationParameters.get(1).toString());
                    }
                    ...
                    bookTaxiButton.setText("Distance to driver: " + distanceToDriver + " meters");
            ...
            case CHECK_SETTINGS_CODE:
                ...
                switch (resultCode) {
                    ...
                    case Activity.RESULT_OK:
                        Log.d("PassengerMapsActivity", "User has agreed to change location" +
                                "settings");
                        startLocationUpdates();
                        break;

                    case Activity.RESULT_CANCELED:
                        Log.d("PassengerMapsActivity", "User has not agreed to change location" +
                                "settings");
                        isLocationUpdatesActive = false;
                        updateLocationUi();
                        break;
