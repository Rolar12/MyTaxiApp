...
public class PassengerSignUpLogInActivity extends AppCompatActivity {
    ...
    private boolean isLoginModActive;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passenger_sign_up_log_in);
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(PassengerSignUpLogInActivity.this, PassengerMapsActivity.class));
        }
    ...
    private boolean validateName() {
        ...
        if (nameInput.isEmpty()) {
            ...
            textInputName.setError("Name length have to be less than 15 symbols");
            return false;
        } else {
    ...
    private boolean validatePassword() {
        ...
        if (passwordInput.isEmpty()) {
            ...
            textInputPassword.setError("Password length have to be more than 5 symbols");
            return false;
        } else {
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(PassengerSignUpLogInActivity.this,
                                            PassengerMapsActivity.class));
                                    //updateUI(user);
                                } else {
                                    // If sign in fails, display a message to the user.
                                    Log.w(TAG, "signInWithEmail:failure", task.getException());
                                    Toast.makeText(PassengerSignUpLogInActivity.this, "Authentication failed.",
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(PassengerSignUpLogInActivity.this, "User creation failed", Toast.LENGTH_LONG).show();
                                // updateUI(null);
                            }
