...
public class DriverSignUpLogInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver_sign_up_log_in);
        ...
        if (auth.getCurrentUser() != null) {
            startActivity(new Intent(DriverSignUpLogInActivity.this, DriverMapsActivity.class));
        }
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(DriverSignUpLogInActivity.this,
                                            DriverMapsActivity.class));
                                    //updateUI(user);
                                } else {
                                    // If sign in fails, display a message to the user.
                                    Log.w(TAG, "signInWithEmail:failure", task.getException());
                                    Toast.makeText(DriverSignUpLogInActivity.this, "Authentication failed.",
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(DriverSignUpLogInActivity.this, "User creation failed", Toast.LENGTH_LONG).show();
                                // updateUI(null);
                            }
